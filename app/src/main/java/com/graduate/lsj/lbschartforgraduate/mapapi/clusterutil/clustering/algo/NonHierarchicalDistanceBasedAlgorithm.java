...
package com.graduate.lsj.lbschartforgraduate.mapapi.clusterutil.clustering.algo;


import com.baidu.mapapi.model.LatLng;
import com.graduate.lsj.lbschartforgraduate.mapapi.clusterutil.clustering.Cluster;
import com.graduate.lsj.lbschartforgraduate.mapapi.clusterutil.clustering.ClusterItem;
import com.graduate.lsj.lbschartforgraduate.mapapi.clusterutil.projection.Bounds;
import com.graduate.lsj.lbschartforgraduate.mapapi.clusterutil.projection.Point;
import com.graduate.lsj.lbschartforgraduate.mapapi.clusterutil.projection.SphericalMercatorProjection;
import com.graduate.lsj.lbschartforgraduate.mapapi.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.graduate.lsj.lbschartforgraduate.mapapi.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.graduate.lsj.lbschartforgraduate.mapapi.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.graduate.lsj.lbschartforgraduate.mapapi.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.graduate.lsj.lbschartforgraduate.mapapi.clusterutil.clustering.algo
