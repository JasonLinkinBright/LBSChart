...
public class LineEditText extends EditText implements TextWatcher,
    ...
    private int focusedDrawableId = R.drawable.icon_user;// 默认的
    private int unfocusedDrawableId = R.drawable.icon_user_select;
    private int errorDrawableId = R.drawable.icon_user_error;
    Drawable left = null;
    private Context mContext;
    private TextFilledListener listener;
    /**
     * 是否获取焦点，默认没有焦点
     */
...
//                R.styleable.lineEdittext_drawableFocus, R.drawable.icon_user);
//        unfocusedDrawableId = a.getResourceId(
//                R.styleable.lineEdittext_drawableUnFocus, R.drawable.icon_user_select);
//        errorDrawableId = a.getResourceId(
//                R.styleable.lineEdittext_drawableError, R.drawable.icon_user_error);
//        a.recycle();
        init();
    }
...
//        color=getResources().getColor(R.color.text_hint,null);
        setStatus(status);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            del_btn = mContext.getResources().getDrawable(R.drawable.del_but_bg, null);
            del_btn_down = mContext.getResources().getDrawable(R.drawable.del_but_bg_down, null);
        } else {
...
//  }
    ...
    public void setStatus(int status) {
        ...
        if (status == STATUS_ERROR) {
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    left = getResources().getDrawable(errorDrawableId, null);
                } else {
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    left = getResources().getDrawable(focusedDrawableId, null);
                } else {
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    left = getResources().getDrawable(unfocusedDrawableId, null);
                } else {
...
//          this.setCompoundDrawables(left, null, null, null);
    ...
    public void setTextFilledListener(TextFilledListener listener){
